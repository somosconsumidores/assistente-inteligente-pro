...
const Header = () => {
  ...
  return <>
        ...
        <div className="mobile-padding py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <a href="#precos" className="text-gray-300 hover:text-blue-400 transition-colors touch-target">B.IA</a>
            </nav>
            ...
            <div className="hidden sm:flex items-center space-x-2 lg:space-x-3">
              ...
              {user ? <div className="flex items-center space-x-2 lg:space-x-4">
                  ...
                  <Button variant="outline" size="sm" onClick={handleLogout} className="flex items-center space-x-1 text-red-400 border-red-800 hover:bg-red-900/20 touch-target">
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && <div className="fixed inset-0 z-40 bg-black/50 backdrop-blur-sm sm:hidden" onClick={closeMobileMenu}>
            ...
            <nav className="mobile-padding py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-700 space-y-3">
                ...
                {user ? <>
                    ...
                    <Button variant="outline" className="w-full justify-center text-red-400 border-red-800 hover:bg-red-900/20 touch-target" onClick={handleLogout}>
