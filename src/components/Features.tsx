...
const Features = () => {
  ...
  const benefits = ['Acesso gratuito ao assistente de direito', 'Interface otimizada para mobile', 'Suporte técnico especializado', 'Atualizações constantes da IA', 'Histórico de conversas salvo', 'Exportação de documentos'];
  return <section id="funcionalidades" className="mobile-padding py-12 sm:py-16 lg:py-20 bg-gray-950/50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
          ...
          return <Card key={index} className="border-gray-800 bg-gray-900/50 backdrop-blur-sm hover-lift transition-all duration-300 group">
        ...
        <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-gray-800">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-3 sm:space-y-4">
              {benefits.map((benefit, index) => <div key={index} className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-800/50 transition-colors">
