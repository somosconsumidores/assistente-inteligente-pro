...
const FinancialChat: React.FC<FinancialChatProps> = ({ onComplete }) => {
          ...
          {currentStep.type === 'multiselect' ? (
            ...
            <div className="flex space-x-2">
              <Input
                ...
                placeholder={currentStep.type === 'number' ? 'Digite o valor...' : 'Digite sua resposta...'}
                disabled={isLoading}
                className="flex-1"
              />
              <Button
                ...
                size="icon"
                className="bg-teal-950 hover:bg-teal-800 text-white font-extrabold text-xl"
              >
