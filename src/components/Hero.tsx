      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="flex justify-center items-center pt-6 sm:pt-12">
          <div className="flex flex-row items-center gap-2 sm:gap-8 justify-center flex-wrap">
            {/* 6 Especialistas */}
            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 rounded-full bg-gradient-to-r from-purple-600/20 to-blue-600/20 backdrop-blur-sm">
            ...
            {/* 24 Horas */}
            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 rounded-full bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm">
            ...
            {/* 100% Gratuito */}
            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 rounded-full bg-gradient-to-r from-green-600/20 to-blue-600/20 backdrop-blur-sm">
