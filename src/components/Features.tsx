...
const Features = () => {
  ...
  const benefits = [
    'Acesso gratuito ao assistente de direito',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-3 sm:space-y-4 mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
            Por que escolher a Biblioteca AI?
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
          {features.map((feature, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="border-gray-800 bg-gray-900/50 backdrop-blur-sm hover-lift transition-all duration-300 group"
              >
